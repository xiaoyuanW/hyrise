...
template <typename T>
const pmr_concurrent_vector<std::experimental::optional<T>> ValueColumn<T>::materialize_values() const {
  pmr_concurrent_vector<std::experimental::optional<T>> values(_values.size(), std::experimental::nullopt, _values.get_allocator());
