 ...
 */
class JitOptimalExpressionOperator : public AbstractReadOnlyOperator {
public:
  JitOptimalExpressionOperator() : AbstractReadOnlyOperator{OperatorType::JitOperatorWrapper} {}
...
protected:
  ...
  std::shared_ptr<AbstractOperator> _on_deep_copy(
    ...
    return std::make_shared<JitOptimalExpressionOperator>();
  }
