...
TEST_F(MinimalColumnStatisticsTest, TwoColumnsEqualsTest) {
  ...
  auto column_stat1 = std::make_shared<MinimalColumnStatistics<int>>(0.0f, 10.f, 0, 10);
  auto column_stat2 = std::make_shared<MinimalColumnStatistics<int>>(0.0f, 10.f, -10, 20);
  ...
  auto column_stat3 = std::make_shared<MinimalColumnStatistics<float>>(0.0f, 10.f, 0.f, 10.f);
  auto column_stat4 = std::make_shared<MinimalColumnStatistics<float>>(0.0f, 3.f, -10.f, 20.f);
  ...
  auto column_stat5 = std::make_shared<MinimalColumnStatistics<float>>(0.0f, 10.f, 20.f, 30.f);
...
TEST_F(MinimalColumnStatisticsTest, TwoColumnsLessThanTest) {
  ...
  auto column_stat1 = std::make_shared<MinimalColumnStatistics<int>>(0.0f, 10.f, 1, 20);
  auto column_stat2 = std::make_shared<MinimalColumnStatistics<int>>(0.0f, 30.f, 11, 40);
  ...
  auto column_stat3 = std::make_shared<MinimalColumnStatistics<float>>(0.0f, 6.f, 0, 10);
  auto column_stat4 = std::make_shared<MinimalColumnStatistics<float>>(0.0f, 12.f, -10, 30);
...
TEST_F(MinimalColumnStatisticsTest, Dummy) {
  {
    auto dummy_column_statistics = MinimalColumnStatistics<int>::dummy();
    EXPECT_EQ(dummy_column_statistics.min(), AllTypeVariant{0});
    EXPECT_EQ(dummy_column_statistics.max(), AllTypeVariant{0});
  }
  {
    auto dummy_column_statistics = MinimalColumnStatistics<float>::dummy();
    EXPECT_EQ(dummy_column_statistics.min(), AllTypeVariant{0.0f});
    EXPECT_EQ(dummy_column_statistics.max(), AllTypeVariant{0.0f});
  }
  {
    auto dummy_column_statistics = MinimalColumnStatistics<double>::dummy();
    EXPECT_EQ(dummy_column_statistics.min(), AllTypeVariant{0.0});
    EXPECT_EQ(dummy_column_statistics.max(), AllTypeVariant{0.0});
  }
  {
    auto dummy_column_statistics = MinimalColumnStatistics<std::string>::dummy();
    EXPECT_EQ(dummy_column_statistics.min(), AllTypeVariant{""});
    EXPECT_EQ(dummy_column_statistics.max(), AllTypeVariant{""});
  }
}
