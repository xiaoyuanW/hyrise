...
class DpCcpTest : public ::testing::Test {
 public:
  void SetUp() override {
    ...
    const auto column_statistics_a_a = std::make_shared<MinimalColumnStatistics<int32_t>>(0.0f, 10.0f, 1, 50);
    const auto column_statistics_b_a = std::make_shared<MinimalColumnStatistics<int32_t>>(0.0f, 10.0f, 40, 100);
    const auto column_statistics_c_a = std::make_shared<MinimalColumnStatistics<int32_t>>(0.0f, 10.0f, 1, 100);
